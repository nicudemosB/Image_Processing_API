...
exports.resizeImage = exports.processImage = exports.getImageInfo = void 0;
...
var resizeImage = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                imagePath = path_1.default.join(__dirname, '../images/encenadaport.jpg');
                outputImagePath = path_1.default.join(__dirname, '../images/resized-sample.jpg');
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, sharp_1.default)(imagePath).resize(300, 200).toFile(outputImagePath)];
            case 2:
                _a.sent();
